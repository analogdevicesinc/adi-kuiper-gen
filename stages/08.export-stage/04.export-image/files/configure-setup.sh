...
Examples:
  ...
  sudo $(basename "$0") --boot-partition /media/user/BOOT --help
  sudo $(basename "$0") --boot-partition /media/user/BOOT ad4003 zed
  sudo $(basename "$0") -b /media/user/BOOT ad4003 zed /dev/sdb3
EOF
