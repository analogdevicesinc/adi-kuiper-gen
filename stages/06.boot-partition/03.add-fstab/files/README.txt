...
Create an extlinux folder and copy socfpga_arria10_common/extlinux.conf into it
Then write the preloader (replace mmcblkXp3 with your actual device):
...
Create an extlinux folder and copy socfpga_cyclone5_common/extlinux.conf into it
Then write the preloader (replace mmcblkXp3 with your actual device):
