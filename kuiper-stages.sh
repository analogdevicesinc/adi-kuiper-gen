...
export CONFIG_DOCKER=${CONFIG_DOCKER:-n}
export CONFIG_OPENOCD=${CONFIG_OPENOCD:-n}
export CONFIG_OPENOCD_CONFIGURE_ARGS=${CONFIG_OPENOCD_CONFIGURE_ARGS:-""}
export CONFIG_AD_R1M=${CONFIG_AD_R1M:-n}
